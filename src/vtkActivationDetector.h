...
public:
    ...
    vtkGetMacro(DetectionMethod, int);//int GetDetectionMethod(){return this->DetectionMethod;}
    vtkSetMacro(DetectionMethod, int);//void SetDetectionMethod(int s) {this->DetectionMethod=s;}
