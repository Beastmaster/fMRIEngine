...
class  VTK_FMRIENGINE_EXPORT vtkGLMEstimator : public vtkActivationEstimator
{
    ...
    vtkFloatArray *GetTimeCourse(int i, int j, int k,vtkInformationVector **inputVector);
 
    // Description:
    // Returns the time course of the defined ROI. 
    vtkFloatArray *GetRegionTimeCourse(vtkInformationVector **inputVector);
	...
	//change by qinshuo-9-16
	//http://www.vtk.org/Wiki/VTK/Examples/Developers/MultipleInputConnections
    ...
    void ComputeMeans(vtkInformationVector **inputVector);
